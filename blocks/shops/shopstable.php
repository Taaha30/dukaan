<?php
function reloadShop($shop,$cat){
echo "<div class='boxfull-new'>";
			$blocknumb = 0;
				foreach ($shop as $image => $value) {
         ...
         //
				 ...
				 // }
					...
					if ($value['block'] == 1) {
						...
						<div><span class='searchasset'><img src=".$value['shopimage']."></span><br><span class='small'>".''."</span></div>
							<div><span class='searchasset'>".$value['shopname']."</span><br><span class='small'>".''."</span></div>
							...
							<span class ='action-buts' id='unblockbut".$blocknumb."' onclick='unblockShops(this.id, \"shop-table\")'><ion-icon name='eye'></ion-icon> Unblock</span>
						...
						echo "<div class='runnames blocknumb'>
							...
							<div><form><input type='hidden' name='rowid' value='".$value["uid"]."'/>
							<span class='action-buts edit-but runs-edit' onclick='editDropdown()' data-key='edit-run' data-value='".$value["uid"]."'><ion-icon name='create'></ion-icon> Edit</span>
							<span class ='action-buts' id='blockbut".$blocknumb."' onclick='blockShops(this.id, \"shop-table\")'><ion-icon name='eye-off'></ion-icon> Block</span>
							<div class='delete-but'>
							<div class='delete-menu'>
