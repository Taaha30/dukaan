<?php
function reloadProducts($product,$cat){
echo "<div class='boxfull-new'>";
			$blocknumb = 0;
				foreach ($product as $image => $value) {
         ...
         //
				 ...
				 // }
					...
					if ($value['block'] == 1) {
						...
						<div><span class='searchasset'><img src=".$value['productimage']."></span><br><span class='small'>".''."</span></div>
							<div><span class='searchasset'>".$value['productname']."</span><br><span class='small'>".''."</span></div>
							...
							<span class ='action-buts' id='unblockbut".$blocknumb."' onclick='unblockProducts(this.id, \"product-table\")'><ion-icon name='eye'></ion-icon> Unblock</span>
						...
						echo "<div class='runnames blocknumb'>
							...
							<div><form><input type='hidden' name='rowid' value='".$value["uid"]."'/>
							<span class='action-buts edit-but runs-edit' onclick='editDropdown()' data-key='edit-run' data-value='".$value["uid"]."'><ion-icon name='create'></ion-icon> Edit</span>
							<span class ='action-buts' id='blockbut".$blocknumb."' onclick='blockProducts(this.id, \"product-table\")'><ion-icon name='eye-off'></ion-icon> Block</span>
							<div class='delete-but'>
							<div class='delete-menu'>
